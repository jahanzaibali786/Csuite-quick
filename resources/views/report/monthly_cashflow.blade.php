                ...
                <div class="mt-2 mb-2 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#daily-chart"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    ...
                                    onclick="window.location.href = '{{ route('report.quarterly.cashflow') }}'"
                            ...
                            <div class="dropdown-menu p-3" style="min-width: 300px;">
                                <div class="card shadow-none border-0">
                                    <div class="card-body p-0">
                                        {{ Form::open(['route' => ['report.monthly.cashflow'], 'method' => 'GET', 'id' => 'monthly_cashflow']) }}
                                        <div class="row">
