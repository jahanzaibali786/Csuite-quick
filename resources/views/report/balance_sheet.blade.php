            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body {{ $collapseview == 'expand' ? 'collapse-view' : '' }}">
                                ...
                                <div class="account-main-inner py-2">
                                        ...
                                        <div class="border-bottom py-2">
                                                    ...
                                                    @foreach ($records as $key => $record)
                                                        ...
                                                        @if (
                                                            ...
                                                            <div
                                                                ...
                                                                <p class="text-primary mb-2 float-end text-end">
                                                                    @if ($type == 'Assets')
                                                                        {{ \Auth::user()->priceFormat(str_replace('-', '', $record['netAmount'])) }}
                                                                    @else
                                                                        {{ \Auth::user()->priceFormat($record['netAmount']) }}
                                                                    @endif
                                                                </p>
                                            ...
                                            <div
                                                ...
                                                <p class="fw-bold mb-2 text-end">
                                                    @if ($type == 'Assets')
                                                        @php $a=$record['netAmount'] ? $record['netAmount'] : 0 @endphp
                                                        {{ \Auth::user()->priceFormat(str_replace('-', '', $a)) }}
                                                    @else
                                    ...
                                    <div
                                        ...
                                        <h6 class="fw-bold mb-0 text-end">
                                            @if ($type == 'Assets')
                                                {{ \Auth::user()->priceFormat(str_replace('-', '', $total)) }}
                                                @else{{ \Auth::user()->priceFormat($total) }}
                                            @endif
                                        </h6>
                                    </div>
                                    @php
                        ...
                        @endforeach
                        @php
                            $subtotal = $totalAmount + $netProfit;
                        @endphp
                        <div
                            class="aacount-title d-flex align-items-center justify-content-between border-top border-bottom py-2 px-2 pe-0">
                            <h6 class="fw-bold mb-0">{{ 'Accumulated ( Loss ) / Profit  ' }}</h6>
                            <h6 class="fw-bold mb-0 text-end">
                        ...
                        <div
                            ...
                            <h6 class="fw-bold mb-0 text-end">
                                {{ \Auth::user()->priceFormat($subtotal) }}
                            </h6>
                        </div>
                    </div>
                </div>
