...
@section('content')
            ...
            <div class="header-actions">
                ...
                <div class="actions">
                    ...
                    <button class="btn btn-icon"
                        onclick="exportDataTable('sales-by-customer-detail-table', '{{ __('Sales by Customer Detail') }}', 'print')"><i
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content p-0">
                    ...
                    <div class="modal-body text-center row">
                        <div class="col-md-6">
                            <button onclick="exportDataTable('sales-by-customer-detail-table', '{{ __('Sales by Customer Detail') }}')"
                        ...
                        <div class="col-md-6">
                            <button
                                onclick="exportDataTable('sales-by-customer-detail-table', '{{ __('Sales by Customer Detail') }}', 'pdf')"
                                class="btn btn-success mx-auto w-75 justify-content-center text-center"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderLast() {
                if ($last.length) $last.text(`Last updated ${rel(lastUpdatedAt)}`);
            }
            ...
            $('#start-date, #end-date, #accounting-method, #filter-customer-name').on('change', function() {
                updateHeaderDate();
                pushUrlAndReload();
            });
          ...
          <label class="qb-pill">
                        ...
                        onEnd: function() {
                            ...
                            if (api && api.colReorder && typeof api.colReorder.order === 'function') {
                                try {
                                    ...
                                    localStorage.setItem('sbc-detail-col-order', JSON.stringify(
                                        newOrder));
            ...
            $('#btn-save').on('click', function() {
                const name = prompt('Enter report name:', 'Sales by Customer Detail - ' + new Date()
