    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 mb-2 d-flex justify-content-between align-items-center" id="multiCollapseExample1">
                ...
                {{-- Receivables Report Filters Dropdown --}}
                <div class="dropdown">
                    <button class="btn btn-outline-primary dropdown-toggle" type="button" id="receivableFilterDropdown"
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 d-flex justify-content-between">
                                        <a href="{{ route('report.receivables') }}"
                                            ...
                                            <tbody>
                                                @php
                                                    ...
                                                    foreach ($receivableCustomers as $item) {
                                                        ...
                                                        $mergedArray[$name]['credit_price'] += floatval(
                                                            $item['credit_price'],
                                                        );
                                                    }
                                                ...
                                                @foreach ($resultArray as $receivableCustomer)
                                                    <tr>
                                                        @php
                                                            ...
                                                            $balance =
                                                                $customerBalance - $receivableCustomer['credit_price'];
                                                            $total += $balance;
                                                        @endphp
                                                ...
                                                @foreach ($receivableDetails as $receivableDetail)
                                                    <tr>
                                                        @php
                                                            ...
                                                            if ($receivableDetail['invoice']) {
                                                                $itemTotal =
                                                                    $receivableBalance * $receivableDetail['quantity'];
                                                            } else {
