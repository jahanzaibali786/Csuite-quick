            ...
            <div class="header-actions">
                ...
                <div class="actions">
                    ...
                    <button class="btn btn-icon"
                        onclick="exportDataTable('sales-tax-liability-table', '{{ __('Sales Tax Liability Report') }}', 'print')"><i
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content p-0">
                    ...
                    <div class="modal-body text-center row">
                        <div class="col-md-6">
                            <button
                                onclick="exportDataTable('sales-tax-liability-table', '{{ __('Sales Tax Liability Report') }}')"
                        ...
                        <div class="col-md-6">
                            <button
                                onclick="exportDataTable('sales-tax-liability-table', '{{ __('Sales Tax Liability Report') }}', 'pdf')"
                                class="btn btn-success mx-auto w-75 justify-content-center text-center"
            ...
            <div class="modal-content">
                ...
                <div class="filter-group">
                    ...
                    <input type="text" id="customer-name" class="form-control"
                        value="{{ $filter['selectedCustomerName'] ?? '' }}" placeholder="Enter customer name">
                </div>
                ...
                <div class="filter-group">
                    ...
                    <input type="text" id="product-name" class="form-control"
                        value="{{ $filter['selectedProductName'] ?? '' }}" placeholder="Enter product/service name">
                </div>
            </div>
        </div>
    </div>
        ...
        <tr>
          ...
          <td class="text-left">${money(r.tax_amount)}</td>
            ...
            $('#btn-save').on('click', function() {
                const name = prompt('Enter report name:', 'Sales Tax Liability Report - ' + new Date()
            ...
            function applyViewOptions() {
                ...
                css += $('#opt-compact').prop('checked') ?
                    '#sales-tax-liability-table th,#sales-tax-liability-table td{padding:8px 12px;}' :
                    '#sales-tax-liability-table th,#sales-tax-liability-table td{padding:12px 16px;}';
                css += $('#opt-hover').prop('checked') ?
                    '#sales-tax-liability-table tbody tr:hover{background:#f9fafb;}' :
                    '#sales-tax-liability-table tbody tr:hover{background:inherit;}';
                if ($('#opt-striped').prop('checked')) css +=
                    '#sales-tax-liability-table tbody tr:nth-child(even){background-color:#f8f9fa;}';
                css += $('#opt-borders').prop('checked') ?
                    '#sales-tax-liability-table th,#sales-tax-liability-table td{border:1px solid #e5e7eb;}' :
                    '#sales-tax-liability-table th,#sales-tax-liability-table td{border:none;border-bottom:1px solid #f3f4f6;}';
                css += $('#opt-wrap').prop('checked') ?
                    '#sales-tax-liability-table th,#sales-tax-liability-table td{white-space:normal;word-wrap:break-word;}' :
                    '#sales-tax-liability-table th,#sales-tax-liability-table td{white-space:nowrap;}';
                css += $('#opt-auto-width').prop('checked') ? '#sales-tax-liability-table{table-layout:auto;}' :
                    '#sales-tax-liability-table{table-layout:fixed;}';
                const fs = $('#font-size').val();
                css +=
                    `#sales-tax-liability-table, #sales-tax-liability-table th, #sales-tax-liability-table td{font-size:${fs};}`;
                css += '</style>';
                $('head').append(css);
            }
                    ...
                    onEnd: function() {
                        ...
                        if (table && table.colReorder && typeof table.colReorder.order === 'function') {
                            try {
                                ...
                                localStorage.setItem('sales-tax-liability-column-order', JSON.stringify(
                                    newOrder));
