                                ...
                                <tbody>
                                    ...
                                    @foreach ($accountArrays as $accounts)
                                        @foreach ($accounts as $account)
                                            ...
                                            @if ($account->reference == 'Journal' || $account->reference == 'BRV' || $account->reference == 'BPV' || $account->reference == 'CRV' || $account->reference == 'CPV' || $account->reference == 'Invoice Journal' || $account->reference == 'Bill Journal' || $account->reference == 'Expense Journal')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>@if($account->reference == 'CRV') {{ AUth::user()->CRVNumberFormat($account->reference_id)}} @elseif($account->reference == 'BRV') {{ AUth::user()->BRVNumberFormat($account->reference_id)}}
                                                        ...
                                                        @elseif($account->reference == 'Invoice Journal') {{ AUth::user()->journalNumberFormat($account->reference_id)}} @elseif($account->reference == 'Bill Journal') {{ AUth::user()->journalNumberFormat($account->reference_id)}} @elseif($account->reference == 'Expense Journal') {{ AUth::user()->journalNumberFormat($account->reference_id)}} 
