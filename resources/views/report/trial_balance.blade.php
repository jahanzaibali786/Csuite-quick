                            ...
                            @if ($view == 'collapse')
                                @foreach ($accounts as $key => $record)
                                        ...
                                        <div class="account-inner d-flex align-items-center justify-content-between ps-3">
                                            ...
                                            @if($type == 'Assets') 
                                                ...
                                                <p class="text-primary  mb-2 text-end me-5">
                                                    {{ \Auth::user()->priceFormat($record['totalDebit'] - $record['totalCredit']) }}</p>
                                                <p class="text-primary mb-2  float-end text-end">
                                                    {{ \Auth::user()->priceFormat(0) }}</p>
                                            @elseif($type =='Liabilities' || $type == 'Equity' || $type == 'Income')
                                                <p class="text-primary mb-2 me-5 text-end">
                                                    {{ \Auth::user()->priceFormat(0) }}</p>
                                                <p class="text-primary float-end mb-2 text-end">
                                                    {{ \Auth::user()->priceFormat($record['totalCredit'] - $record['totalDebit'] ) }}</p>
                                    ...
                                    @php
                                        ...
                                        {
                                            if($type == 'Assets') {
                                                $totalDebit += $record['totalDebit'] -  $record['totalCredit'];
                                                $totalCredit += 0;
                                            }else if($type ='Liabilities' || $type = 'Equity' || $type = 'Income'){
                                                 $totalDebit += 0;
                                                $totalCredit +=$record['totalCredit'] - $record['totalDebit'] ;
                                            }else{
                                        ...
                                        <div class="account-inner d-flex align-items-center justify-content-between ps-3">
                                            ...
                                            @if($type == 'Assets') 
                                                ...
                                                <p class="text-primary mb-2 fw-bold float-end text-end">
                                                    {{ \Auth::user()->priceFormat(0) }}</p>
                                            @elseif($type =='Liabilities' || $type == 'Equity' || $type == 'Income')
                                                <p class="text-primary mb-2 me-5 fw-bold  text-end">
                                                    {{ \Auth::user()->priceFormat(0) }}</p>
                                                <p class="text-primary fw-bold mb-2 float-end text-end">
                                                    {{ \Auth::user()->priceFormat($record['totalCredit'] - $record['totalDebit']) }}</p>
                                            @else
                                                <p class="text-primary fw-bold mb-2 text-end me-5">
                                                    {{ \Auth::user()->priceFormat($record['totalDebit']) }}</p>
                                        ...
                                        <div class="account-inner d-flex align-items-center justify-content-between ps-3">
                                            ...
                                            @if($type == 'Assets') 
                                                ...
                                                <p class="text-dark fw-bold mb-2 float-end text-end">
                                                    {{ \Auth::user()->priceFormat(0) }}</p>
                                            @elseif($type =='Liabilities' || $type == 'Equity' || $type == 'Income')
                                                <p class="text-dark fw-bold mb-2 me-5 text-end">
                                                    {{ \Auth::user()->priceFormat(0) }}</p>
                                                <p class="text-dark fw-bold mb-2 float-end text-end">
                                                    {{ \Auth::user()->priceFormat($record['totalCredit'] - $record['totalDebit']) }}</p>
                                            @else
