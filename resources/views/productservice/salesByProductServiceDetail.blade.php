...
@section('content')
    <style>
        ...
        .sales-by-product-service-detail-table {
            width: 100%;
            border-collapse: collapse;
            font-size: 13px;
        }

        .sales-by-product-service-detail-table th {
            background: #f9fafb;
        ...
        .sales-by-product-service-detail-table td {
            padding: 12px 16px;
        ...
        .sales-by-product-service-detail-table tbody tr:hover {
            background: #f9fafb;
        }
    ...
    <div class="quickbooks-report">
            ...
            <div class="header-actions">
                ...
                <div class="actions">
                    ...
                    <button class="btn btn-icon"
                        onclick="exportDataTable('sales-by-product-service-detail-table', '{{ __('Sales by Product/Service Detail') }}', 'print')"><i
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content p-0">
                    ...
                    <div class="modal-body text-center row">
                        <div class="col-md-6">
                            <button
                                onclick="exportDataTable('sales-by-product-service-detail-table', '{{ __('Sales by Product/Service Detail') }}')"
                        ...
                        <div class="col-md-6">
                            <button
                                onclick="exportDataTable('sales-by-product-service-detail-table', '{{ __('Sales by Product/Service Detail') }}', 'pdf')"
                                class="btn btn-success mx-auto w-75 justify-content-center text-center"
        ...
        <div class="report-content">
            ...
            <div class="table-container">
                {!! $dataTable->table([
                    'class' => 'table sales-by-product-service-detail-table',
                    'id' => 'sales-by-product-service-detail-table',
                ]) !!}
            </div>
                ...
                <ul id="qb-columns-list">
                    ...
                    <li class="qb-col-item" data-column="3"><span class="qb-handle"><i
                        ...
                        <label class="qb-pill"><input type="checkbox" data-col="3" checked><span class="pill"><i
                                    class="fa fa-check"></i></span><span class="qb-col-name">Product/Service full
                                name</span></label>
                    </li>
...
@push('script-page')
    ...
    <script>
        $(function() {
            ...
            $('#close-general-options,#cancel-general-options').on('click', () => overlay(
                '#general-options-overlay', false));
            ...
            $('#btn-save').on('click', function() {
                const name = prompt('Enter report name:', 'Sales by Product/Service Detail - ' + new Date()
                ...
                if (this.id === 'report-period' && period !== 'custom') {
                    ...
                    switch (period) {
                        ...
                        case 'this_quarter': {
                            ...
                            endDate = new Date(today.getFullYear(), q * 3 + 3, 0).toISOString().split('T')[
                                0];
                        }
                        break;
                        case 'this_year':
            ...
            function applyViewOptions() {
                ...
                css += $('#opt-compact').prop('checked') ?
                    '.sales-by-product-service-detail-table th,.sales-by-product-service-detail-table td{padding:8px 12px;}' :
                    '.sales-by-product-service-detail-table th,.sales-by-product-service-detail-table td{padding:12px 16px;}';
                css += $('#opt-hover').prop('checked') ?
                    '.sales-by-product-service-detail-table tbody tr:hover{background:#f9fafb;}' :
                    '.sales-by-product-service-detail-table tbody tr:hover{background:inherit;}';
                if ($('#opt-striped').prop('checked')) css +=
                    '.sales-by-product-service-detail-table tbody tr:nth-child(even){background-color:#f8f9fa;}';
                css += $('#opt-borders').prop('checked') ?
                    '.sales-by-product-service-detail-table th,.sales-by-product-service-detail-table td{border:1px solid #e5e7eb;}' :
                    '.sales-by-product-service-detail-table th,.sales-by-product-service-detail-table td{border:none;border-bottom:1px solid #f3f4f6;}';
                css += $('#opt-wrap').prop('checked') ?
                    '.sales-by-product-service-detail-table th,.sales-by-product-service-detail-table td{white-space:normal;word-wrap:break-word;}' :
                    '.sales-by-product-service-detail-table th,.sales-by-product-service-detail-table td{white-space:nowrap;}';
                css += $('#opt-auto-width').prop('checked') ?
                    '.sales-by-product-service-detail-table{table-layout:auto;}' :
                    '.sales-by-product-service-detail-table{table-layout:fixed;}';
                if ($('#opt-equal-width').prop('checked')) css +=
                    '.sales-by-product-service-detail-table th,.sales-by-product-service-detail-table td{width:11%;}';
                const fs = $('#font-size').val();
                css +=
                    `.sales-by-product-service-detail-table, .sales-by-product-service-detail-table th, .sales-by-product-service-detail-table td{font-size:${fs};}`;
                css += '</style>';
                $('head').append(css);
            }
