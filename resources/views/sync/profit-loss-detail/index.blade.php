    ...
    <div class="content-wrapper">
        <div class="d-flex flex-column w-tables rounded mt-3 bg-white">
            <div class="report-title-section p-2">
                <h2 class="report-title">Profit & Loss Detail</h2>
                <p class="date-range">
            ...
            <div class="table-responsive p-4">
                {!! $dataTable->table(['class' => 'table table-hover border-0 w-100 profit-loss-table' , 'id' => 'profit-loss-table']) !!}
            </div>
        </div>
    </div>
    <!-- Filter Modal -->
    ...
    <script>
        ...
        function refreshTable() {
            ...
            if (window.LaravelDataTables && window.LaravelDataTables["profit-loss-table"]) {
                console.log('refreshing in table');
