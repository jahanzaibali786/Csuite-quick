...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="report-header">
            <h4 class="mb-0">Customer Balance Summary</h4>
        ...
        <div class="report-content">
            <div class="report-title-section">
                <h2 class="report-title">Customer Balance Summary</h2>
            ...
            <div class="modal-content">
                ...
                <div class="columns-list" id="sortable-columns">
                    ...
                    <div class="column-item" data-column="1">
                        <i class="fa fa-grip-vertical handle"></i>
                        <label class="checkbox-label">
                            <input type="checkbox" checked> Invoice Balance
                        </label>
                    </div>
                    <div class="column-item" data-column="2">
                        <i class="fa fa-grip-vertical handle"></i>
                        <label class="checkbox-label">
                            <input type="checkbox" checked> Available Credits
                        </label>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('.btn-icon[title="Print"]').on('click', function() {
                ...
                const printContent = `
                    ...
                    <html>
                    <head>
                        <title>Customer Balance Summary - Print</title>
                        <style>
                    ...
                    <body>
                        <div class="report-title">Customer Balance Summary</div>
            ...
            $('.btn-save').on('click', function() {
                const reportName = prompt('Enter report name:', 'Customer Balance Summary - ' + moment()
                    .format(
                        'YYYY-MM-DD'));
                if (reportName) {
