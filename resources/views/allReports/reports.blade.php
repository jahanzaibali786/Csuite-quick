...
@push('script-page')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('#reportsAccordion .accordion-collapse').forEach(el => el.classList.add(
                'show'));
            document.querySelectorAll('#reportsAccordion .accordion-button').forEach(btn => {
            ...
            document.addEventListener('click', function(e) {
                const help = e.target.closest('.report-help');
                if (!help) return;
                e.preventDefault();
                e.stopPropagation();
                const row = help.closest('li.report-item');
                if (!row) return;
                row.parentElement.querySelectorAll('.report-desc').forEach(d => {
                    if (!row.contains(d)) d.remove();
                });
            ...
            if (favs.length === 0) {
                ...
                const available = new Set(Array.from(document.querySelectorAll('li.report-item')).map(li => li
                    .dataset.key).filter(Boolean));
                ...
                <div class="card-body table-border-style">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="FavoritesOverviewCollapse"
                                ...
                                <div class="accordion-body p-0">
                                    ...
                                    <ul id="favoritesList" class="list-unstyled mb-0 ms-3 row g-0"><!-- filled by JS -->
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="businessOverviewCollapse"
                                ...
                                <div class="accordion-body p-0">
                                    <ul class="list-unstyled mb-0 ms-3 row g-0">
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'balance-sheet.index' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'balance-sheet.index',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="balance-sheet.index" role="button"
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'reports.profit_loss' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'reports.profit_loss',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="reports.profit_loss" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'balance-sheet-detail.index' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'balance-sheet-detail.index',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="balance-sheet-detail.index" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'profit-loss-detail.index' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'profit-loss-detail.index',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="profit-loss-detail.index" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'balance-sheet-standard.index' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'balance-sheet-standard.index',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="balance-sheet-standard.index" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'profit-loss-by-month' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'profit-loss-by-month',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="profit-loss-by-month" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'balance-sheet-comparison.index' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'balance-sheet-comparison.index',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="balance-sheet-comparison.index" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'profit-loss-comparison' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'profit-loss-comparison',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="profit-loss-comparison" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'ledger.index' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'ledger.index',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle" data-key="ledger.index"
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'profit-loss-quaterly' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'profit-loss-quaterly',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="profit-loss-quaterly" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'cash-flow.index' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'cash-flow.index',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle" data-key="cash-flow.index"
                                                        role="button" aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                    ...
                    @php
                        $salesAndCustomersReports = [
                            ...
                            [
                                'route' => 'productservice.inventoryValuationSummary',
                                ...
                                <div class="accordion-body p-0">
                                    <ul class="list-unstyled ms-3 mb-0 row g-0">
                                        @foreach ($salesAndCustomersReports as $r)
                                            <li class="col-6 report-item {{ $r['route'] && Request::route()->getName() == $r['route'] ? 'active' : '' }}"
                                                data-key="{{ $r['route'] }}">
                                                <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                    <div class="d-flex align-items-center flex-grow-1"
                                                        style="min-width:0;">
                            ...
                            <div id="salesTaxCollapse"
                                ...
                                <div class="accordion-body p-0">
                                    <ul class="list-unstyled ms-3 mb-0 row g-0">
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'SalesTaxLiabilityReport' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'SalesTaxLiabilityReport',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="SalesTaxLiabilityReport" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'report.taxableSalesSummary' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0%;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'report.taxableSalesSummary',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="report.taxableSalesSummary" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ Request::route()->getName() == 'report.taxableSalesDetail' ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'report.taxableSalesDetail',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="report.taxableSalesDetail" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                    ...
                    @php
                        ...
                        $accountingreports = [
                            'right' => [
                              ...
                              ['route' => 'cash-flow.index', 'name' => __('Cash Flow Statement')],
                            ],
                            'left' => [
                            ...
                            <div id="posCollapse"
                                ...
                                <div class="accordion-body p-0">
                                    <ul class="list-unstyled ms-3 mb-0 row g-0">
                                        ...
                                        <li class="col-6 report-item {{ request()->is('reports-warehouse') ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'report.warehouse',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="report.warehouse" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ request()->is('reports-daily-purchase') || request()->is('reports-monthly-purchase') ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'report.daily.purchase',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="report.daily.purchase" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ request()->is('reports-daily-pos') || request()->is('reports-monthly-pos') ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'report.daily.pos',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="report.daily.pos" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
                                        ...
                                        <li class="col-6 report-item {{ request()->is('reports-pos-vs-purchase') ? 'active' : '' }}"
                                            ...
                                            <div class="d-flex align-items-center w-100" style="min-width:0;">
                                                <div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
                                                    ...
                                                    @include('allReports._help', [
                                                        'routeKey' => 'report.pos.vs.purchase',
                                                    ])
                                                </div>
                                                <span class="report-actions d-inline-flex align-items-center ms-auto pe-3">
                                                    <i class="bi bi-star text-muted fav-toggle"
                                                        data-key="report.pos.vs.purchase" role="button"
                                                        aria-label="Toggle favorite"></i>
                                                    <i class="bi bi-three-dots-vertical text-muted ms-1"></i>
                                                </span>
                                            </div>
