                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                'id'=>'customer','data-url'=>route('invoice.customer'),'required'=>'required',
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{ Form::select('category_id', $category,null,array('class' => 'form-control select','required'=>'required','data-create-url'=>route('product-category.create'),'data-create-title'=>__('Create New Category'))) }}
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
