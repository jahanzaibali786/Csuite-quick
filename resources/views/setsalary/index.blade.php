...
@section('action-btn')
    @if(Auth::user()->id == '41')
    <div class="float-end">
        <a href="#" data-size="md" data-url="{{ route('employee_create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create Employee')}}" data-title="{{__('Create Employee')}}" class="btn btn-sm btn-primary">
