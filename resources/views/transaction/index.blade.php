...
@section('content')
    ...
    <div class="col-sm-12">
        <div class="mb-2 d-flex justify-content-between align-items-center">
            ...
            {{-- Filter Dropdown --}}
            <div class="dropdown">
                <button class="btn btn-outline-primary dropdown-toggle" type="button" id="transactionFilterDropdown"
            ...
            {{-- Export + Download --}}
            <div>
                <a href="{{ route('transaction.export') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
                   title="{{ __('Export') }}">
